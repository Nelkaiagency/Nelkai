        ...
        <div className="rounded-3xl border border-gray-800 bg-gradient-to-br from-[#111115] via-[#0F1116] to-[#0A0A0F] p-12 md:p-16 shadow-[0_30px_80px_rgba(124,58,237,0.14)] overflow-hidden relative">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
              Built for construction, steel manufacturing, trucking logistics, and general contracting work.
            </h2>

            <p className="text-base text-gray-400 mb-8 leading-relaxed">
              We work with operational teams that need clear dispatch, field coordination, and reliable visibility across crews, sites, and daily handoffs.
            </p>
