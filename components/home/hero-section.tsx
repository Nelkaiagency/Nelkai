    ...
    <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-balance">
          <span className="text-gradient">We Build the Machine.</span>
          <br />
          <span className="text-foreground">You Run the Business.</span>
        </h1>
        
        <p className="mt-8 text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
          We automate your Instagram, invoicing, emails, client management, and NFC systems — all connected to a live database — so you can focus on high-leverage growth and execution.
        </p>
